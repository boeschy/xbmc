...
constexpr const int ACTION_SUBTITLE_BITMAP_ZOOM_IN = 252; //!< Enlarge bitmap subtitles
constexpr const int ACTION_SUBTITLE_BITMAP_ZOOM_OUT = 253; //!< Shrink bitmap subtitles
constexpr const int ACTION_SUBTITLE_BITMAP_POSITION = 254; //!< Toggle position override for bitmap subtitles
